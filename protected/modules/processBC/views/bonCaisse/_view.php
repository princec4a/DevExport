	...
	<div class="widget-box">
		...
		<div class="widget-body">
			<div class="widget-main">
				...
				<div class=""><span style="display: block; float: left; width: 85%;">Transport :</span> <strong><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0',$data->transport, "EUR")); ?></strong></div>
				<hr style="margin: 0 0 5px;" />
