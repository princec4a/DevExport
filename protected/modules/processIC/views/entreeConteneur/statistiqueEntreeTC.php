...
<div class="col-xs-12">
    ...
    <div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <?php echo CHtml::ajaxButton('Rechercher',CHtml::normalizeUrl(array('sortieConteneur/statistiqueSortieTC','render'=>true)),
                array(
                    'dataType'=>'json',
                    'type'=>'post',
                    'success'=>'function(data) {
                        ...
                        if(data.nb > 0){
                            $("#success").show("slow");
                            $("#danger").hide();
                            $("span.comment").html(data.booking);
                            $("span.link").html("<a class=\"btn btn-sm btn-success\" target=\"_blank\" href=\"..\/entreeConteneur\/statistiqueEntreeTCByBooking\/booking\/"+data.booking+"\/du\/"+data.du+"\/au\/"+data.au+"\/doc\/statistiqueSortieTCByBooking \"><i class=\"ace-icon fa fa-print bigger-160\"></i> Prévisualiser</a>");
                        }
                        else{
                            $("#success").hide();
                            $("#danger").show("slow");
                            $("span.comment_error").html("Aucun info trouvée, veuiller verifier sélectionner le bon booking ou une période correcte !!");
                        }
                    }',
                    'beforeSend'=>'function(){
                       $("#AjaxLoader").show();
