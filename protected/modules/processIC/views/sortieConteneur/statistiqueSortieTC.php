                ...
                array(
                    ...
                    'success'=>'function(data) {
                        ...
                        if(data.nb > 0){
                            ...
                            $("span.link").html("<a class=\"btn btn-sm btn-success\" target=\"_blank\" href=\"..\/sortieConteneur\/statistiqueSortieTCByBooking\/booking\/"+data.booking+"\/du\/"+data.du+"\/au\/"+data.au+"\/doc\/statistiqueSortieTCByBooking \"><i class=\"ace-icon fa fa-print bigger-160\"></i> Prévisualiser</a>");
                        }
                        else{
                            $("#success").hide();
                            $("#danger").show("slow");
