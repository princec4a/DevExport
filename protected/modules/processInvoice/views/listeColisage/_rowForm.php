<?php $row_id = "detailListeColisage-" . $key ?>
<div class='row-fluid' id="<?php echo $row_id ?>">
    ...
    <div class="col-xs-6 col-sm-2">
        <div class="form-group">
            <?php echo $form->labelEx($model,"[$key]poids_brut", array('class'=>'col-sm-3 control-label no-padding-right')); ?>
            <div class="col-sm-9">
                <?php echo $form->textField($model,"[$key]poids_brut", array('class'=>'col-xs-10 col-sm-9')); ?>
                <?php echo $form->error($model,"[$key]poids_brut"); ?>
            </div>
        </div>
    </div>
