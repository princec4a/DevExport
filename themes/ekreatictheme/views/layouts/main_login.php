...
<head>
    ...
    <meta name="description" content="Page de Connexion de l'application DevExporte Conçu et développer par Prince Nelcia TSATY l'ingénieur d'etude à l'OCI" />
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">Dev</span>
                            <span class="white" id="id-text2">Export</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; developpement du congo</h4>
                    </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header blue lighter bigger">
                                        ...
                                        <?php echo UserModule::t("Veuillez vous identifier"); ?>
                                    </h4>
                                ...
                                <div class="toolbar clearfix">
                                    <div>
                                        <a href="#" data-target="#forgot-box" class="forgot-password-link">www.developpementducongo.fr</a>
                                    </div>
                    ...
                    <div class="profile-social-links align-center">
                        ...
                        <a href="https://www.linkedin.com/in/prince-tsaty-b426014b?trk=hp-identity-name" class="tooltip-info" title="" data-original-title="Visit my Twitter" target="_blank">
                            <i class="middle ace-icon fa fa-linkedin-square fa-2x light-blue"></i>
                        </a>
                    </div>
