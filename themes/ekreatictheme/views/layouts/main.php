...
<head>
    ...
    <meta name="description" content="DevExport application développer par l'ingénieur Prince Nelcia TSATY prince.nelcia@gmail.com" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />

    <!-- bootstrap & fontawesome -->
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

    <!-- page specific plugin styles -->
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/colorbox.min.css" />
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/select2.min.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/bootstrap-datepicker3.min.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/bootstrap-editable.min.css" />

    <!-- fancybox

    <link rel="stylesheet" type="text/css" href="<?php //echo Yii::app()->theme->baseUrl;  ?>/assets/source/jquery.fancybox.css" media="screen" />

    <!-- text fonts -->
    <link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/css/fonts.googleapis.com.css" />
...
<script src="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/js/bootbox.js"></script>
...
<script src="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/js/jquery.hotkeys.index.min.js"></script>
...
<script src="<?php echo Yii::app()->theme->baseUrl;  ?>/assets/js/spinbox.min.js"></script>
